...
config = {
    ...
    'ALLOWED_HOSTS': ['*'] if not IS_PRODUCTION_BACKEND else ['basedatastorev1-production.up.railway.app'],
    'CORS_ALLOWED_ORIGINS': [
        'http://localhost:3000',
        'https://baseinterfacev1-production.up.railway.app'
    ],
    'DATABASE_URL': os.environ.get('POSTGRES_URL') if IS_PRODUCTION_BACKEND else os.environ.get('POSTGRES_URL_DEV', 'sqlite:///./dev.db'),
